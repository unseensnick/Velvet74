...
Rules baked in: 0.2 mm tracks at 0.4 mm pitch, 0.6/0.3 mm vias, clearances 0.205 copper / 0.36 hole / 0.5 edge mm (small margins over the JLCPCB-recommended rules because pads are polygonised; 0.13 inside the U1, J1, J2, U2 and U4 courtyards, matching `velvet74.kicad_dru`), no turn sharper than 90 degrees including through a via.
